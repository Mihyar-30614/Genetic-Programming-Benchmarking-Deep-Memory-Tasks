...
# 4 Deep Report
rpt_1_path = os.path.join(local_dir, '8-bit-report/8-progress_report1')
rpt_2_path = os.path.join(local_dir, '8-bit-report/8-progress_report2')
rpt_3_path = os.path.join(local_dir, '8-bit-report/8-progress_report3')
rpt_4_path = os.path.join(local_dir, '8-bit-report/8-progress_report4')
rpt_5_path = os.path.join(local_dir, '8-bit-report/8-progress_report5')
rpt_6_path = os.path.join(local_dir, '8-bit-report/8-progress_report6')
rpt_7_path = os.path.join(local_dir, '8-bit-report/8-progress_report7')
rpt_8_path = os.path.join(local_dir, '8-bit-report/8-progress_report8')
rpt_9_path = os.path.join(local_dir, '8-bit-report/8-progress_report9')
rpt_10_path = os.path.join(local_dir, '8-bit-report/8-progress_report10')
